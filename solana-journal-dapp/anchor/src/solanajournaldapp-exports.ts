...
export const SOLANAJOURNALDAPP_PROGRAM_ID = new PublicKey(SolanajournaldappIDL.address)

// This is a helper function to get the Solanajournaldapp Anchor program.
export function getSolanajournaldappProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...SolanajournaldappIDL, address: address ? address.toBase58() : SolanajournaldappIDL.address } as Solanajournaldapp, provider)
}
